...
def simulate_one_fish(fish_path, simulation_length, simulation_num, terrain, food_num, hard_thr=0,
                      fish_ind=0, fish_num=0, verbose=0):
    """
    ...
    for sim_ind in range(simulation_num):
        ...
        curr_simulation = Simulation(terrain=terrain, fish_list=[curr_fish],

...
values, bin_edges = np.histogram(life_spans_plot, bins=60, range=[0, clip_top_life_span])
...
ax.set_title(f"generation: {generation:05d}, mean life span: {mean_life_span:.0f}", fontsize=16)
# plt.tight_layout()
plt.show()
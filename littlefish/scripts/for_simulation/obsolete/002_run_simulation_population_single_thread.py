...
for fish_ind, fish_path in enumerate(fish_lst):
    ...
    si.simulate_one_fish(fish_path=fish_path, simulation_length=simulation_length, simulation_num=sim_num,
                         terrain_size=terrain_size, sea_level=sea_level, food_num=food_num, hard_thr=hard_thr,
                         fish_ind=fish_ind, fish_num=total_fish_num)

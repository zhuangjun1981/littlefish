...
def run():
    ...
    pe.run(start_generation_ind=0, end_generation_ind=5, brain_mutation=brain_mutation,
           population_size=population_size, process_num=process_num, turnover_rate=turnover_rate,
           simulation_length=simulation_length, terrain_size=terrain_size, sea_portion=sea_portion,
           terrain_filter_sigma=terrain_filter_sigma, food_num=food_num,

...
eye = littlefish.core.fish.Eye2(
    direction="east",
    input_filter=np.array([0.15, 0.3, 0.15, 0.1, 0.2, 0.1]),
    gain=0.005,
    input_type="terrain",
    baseline_rate=0.0,
...
muscle = littlefish.core.fish.Muscle(
    direction="east", baseline_rate=0.1, refractory_period=5000
)
...
connection_eye_hidden0 = littlefish.core.fish.Connection(
    latency=30, amplitude=0.01, rise_time=50, decay_time=100
)
connection_eye_hidden1 = littlefish.core.fish.Connection(
    latency=30, amplitude=0.0001, rise_time=50, decay_time=100
)
connection_hidden0_muscle = littlefish.core.fish.Connection(
    latency=30, amplitude=0.0001, rise_time=50, decay_time=100
)
connection_hidden1_muscle = littlefish.core.fish.Connection(
    latency=30, amplitude=0.01, rise_time=50, decay_time=100
)
...
conn_1_2 = pd.DataFrame(
    [[connection_hidden0_muscle, connection_hidden1_muscle]], columns=[1, 2], index=[3]
)
